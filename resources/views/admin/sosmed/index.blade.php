<x-app-layout title="Sosmed">
    <x-content_header>
        ...
        <x-breadcrumb>
            ...
            <li class="breadcrumb-item item">{{ __('Sosmed') }}</li>
        </x-breadcrumb>
    </x-content_header>
    <!-- Main content -->
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <div class="row" style="gap: 6px;">
                                            ...
                                            <div class="col-sm-3">
                                                <input class="form-control" placeholder="Cari link" name="link" id="filterLink" type="text">
                                            </div>
                                            <div class="col-sm-2">
    ...
    <div class="modal fade" id="modalInput" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Input Sosmed</h5>
    ...
    @push('script')
    <script src="{{ asset('assets/dist/js/pages/sosmed/index.js') }}"></script>
    @endpush
</x-app-layout>
