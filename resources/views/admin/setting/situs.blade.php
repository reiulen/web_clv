    ...
    <div class="col-sm-4">
        <div id="image-preview" class="image-preview p-2">
            <div class="gallery gallery-lg">
                <div class="gallery-item img-preview" id="favicon" style="background-image: url('{{ asset($setting->favicon ?? '') }}');">
...
<div class="form-group row mb-4">
    ...
    <div class="col-sm-4">
        <div id="image-preview" class="image-preview p-2">
            <div class="gallery gallery-lg">
                <div class="gallery-item img-preview" id="logo" style="background-image: url('{{ asset($setting->logo ?? '') }}');">
...
<div class="form-group row mb-4">
    ...
    <div class="col-sm-4">
        <div id="image-preview" class="image-preview p-2">
            <div class="gallery gallery-lg">
                <div class="gallery-item img-preview" id="background_header" style="background-image: url('{{ asset($setting->background_header ?? '') }}');">
                    <button type="button" class="btn btn-danger float-right btn-remove-image" data-key="background_header">
                        <i class="fa fa-trash"></i>
                    </button>
                </div>
            </div>
